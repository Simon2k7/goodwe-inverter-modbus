...
1. **Check sensor-specific ranges**: Some sensors may have tighter ranges (e.g., grid frequency)
2. **Review diagnostics**: See which sensors are being rejected and why
3. **Temporarily disable validation**: Test if issues persist without validation
